...
route('GET', '/api/consumption', async (ctx) => {
  ...
  // the report window still needs to be included. It only reads 0 when
  // that's actually correct: the product genuinely had no movements yet as
  // of that date (e.g. picking a From before the product was ever added).
