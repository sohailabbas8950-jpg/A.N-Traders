...
async function viewConsumption(view) {
  ...
  const load = async () => {
    ...
    // as its opening balance. It's "yesterday's closing stock" relative to
    // From: picking Sep 1 as From shows the balance as of Aug 31, exactly
    // matching the standard "this period's opening = last period's
    // closing" relationship. If a product's true starting stock was never
